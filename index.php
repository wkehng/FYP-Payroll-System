		...
		<div class="wrapper fadeInDown">
		  <div id="formContent">
			...
			<form id="form1" name="form1" method="post" action="login.php">
				<table width="150px" border="0" style="color:Black;align-content: center;">
					<h2 style="color:grey;">Payroll System</h2>
					<br>
					<br>
					<input type="text" name="username" id="username" class="fadeIn second" placeholder="username">
					  <input type="password" id="password" class="fadeIn third" name="password" placeholder="password">
					  <input type="submit" class="fadeIn fourth" name="submit" id="login2" value="Log In">
					</form>
			...
			<!-- Remind Passowrd -->
			<div id="formFooter">
			  <a class="underlineHover" href="resetpassword.php">Change Password</a>
			</div>
